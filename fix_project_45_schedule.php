...
echo "=== ИСПРАВЛЕНИЕ РАСПИСАНИЯ МАСТЕРОВ ПРОЕКТА 45 ===\n\n";

// Находим всех мастеров проекта 45
$users = User::where('project_id', 45)->get();
echo "Мастеров в проекте 45: " . $users->count() . "\n";
...
echo "\n✅ Расписание мастеров проекта 45 исправлено!\n";
