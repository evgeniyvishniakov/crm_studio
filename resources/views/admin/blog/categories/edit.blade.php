...
@section('title', 'Редактировать категорию - Блог')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0">Редактировать категорию: {{ $category->name }}</h1>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Описание категории...">{{ old('description', $category->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="small text-muted">
                                        <div>Статей в категории: <strong>{{ $category->articles->count() }}</strong></div>
                                        <div>Создано: <strong>{{ $category->created_at->format('d.m.Y H:i') }}</strong></div>
                                        <div>Обновлено: <strong>{{ $category->updated_at->format('d.m.Y H:i') }}</strong></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div id="category-preview" class="text-center">
                                    <span class="badge" id="preview-badge" style="background-color: {{ $category->color }}; font-size: 1rem; padding: 8px 16px;">
                                        {{ $category->name }}
                                    </span>
                                </div>
                            </div>
