...
<div class="dashboard-container">
    <div class="services-container">
        <div class="services-header">
            ...
            <div id="notification" class="notification alert alert-success" role="alert">
                ...
                <span class="notification-message">Поставщик успешно добавлен!</span>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addServiceForm">
                    ...
                    <div class="form-group">
                        <label for="serviceContactPerson">Контактное лицо</label>
                    ...
                    <div class="form-group">
                        <label for="serviceInstagram">Instagram</label>
                        <input type="text" id="serviceInstagram" name="instagram" placeholder="@username">
                    </div>
                    <div class="form-group">
                        <label for="serviceInn">ИНН</label>
                        <input type="text" id="serviceInn" name="inn">
                    </div>
                    <div class="form-group">
                        <label for="serviceNote">Примечание</label>
    ...
    <div id="confirmationModal" class="confirmation-modal">
        <div class="confirmation-content">
            ...
            <p>Вы уверены, что хотите удалить этого поставщика?</p>
            ...
            fetch("{{ route('suppliers.store') }}", {
                ...
                .then(data => {
                    if (data.success && data.supplier) {
                        ...
                        newRow.innerHTML = `
                            ...
                            <td>
                                <span class="status-badge ${data.supplier.status ? 'active' : 'inactive'}">
                                    ${data.supplier.status ? 'Активен' : 'Неактивен'}
                                </span>
                            </td>
                            <td class="actions-cell">
                                <button class="btn-edit">
                        ...
                        showNotification('success', `Поставщик "${data.supplier.name}" успешно добавлен`);

                        // Закрываем модальное окно и очищаем форму
                        closeModal();
                        this.reset();
                    } else {
                        throw new Error('Сервер не вернул данные поставщика');
                    }
                })
                .catch(error => {
                    ...
                    if (error.errors) {
                        ...
                        showNotification('error', error.message || 'Произошла ошибка при добавлении поставщика');
                    }
                })
                .finally(() => {
